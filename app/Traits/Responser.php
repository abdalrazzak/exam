...
trait Responser { 
    ...
    public function error($err_num , $msg){
    ...
    public function SuccessMessage($msg = '' , $err_num = 'S000'){
        return response()->json([
            'status' => true ,
            'err_num' => $err_num,
            'msg' => $msg
    ...
    public function ValidationError($code = 'E001' , $validator){
        return $this->error($code, $validator->errors()->first());
    }

    public function codeAccordingToInput($validator){
        $inputs = array_keys($validator->errors()->toArray());
        $code = $this->getErrorCode($inputs) ;
        return $code ;
    }
